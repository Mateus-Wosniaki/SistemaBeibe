...
public class UsuarioDAO implements InterfaceDAO<Usuario> {
    ...
    private static final String BUSCARPORID
            = "select * from public.Usuario u INNER JOIN Endereco e on e.idEndereco = u.idEndereco INNER JOIN Municipio m on m.idMunicipio = e.idMunicipio INNER JOIN Estado es on es.idEstado = m.idEstado INNER JOIN Funcao f on f.idFuncao = u.idFuncao where idusuario = ?";
