                                        ...
                                        <form method="POST" action="index.jsp">
                                            <div class="row">
                                                <div class="col-md-3 pr-1">
                                                    <div class="form-group">
                                                        <label>Nome</label>
                                                        <input type="text" class="form-control" disabled="" value="José Mande Cardoso">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 pr-1">
                                                    <div class="form-group">
                                                        <label>Rua</label>
                                                        <input type="text" class="form-control" disabled="" value="Miguel Abraão">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 pl-1">
                                                    <div class="form-group">
                                                        <label>Bairro</label>
                                                        <input type="text" class="form-control" disabled="" value="Portão">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
